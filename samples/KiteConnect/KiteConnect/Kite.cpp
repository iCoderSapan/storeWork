...
namespace KiteConnect
{
    ...
    class Kite
    {
        ...
        private String USER_AGENT = "SapanClient";

        private string _apiKey;
        private string _accessToken;
        private bool _enableLogging;
        private WebProxy _proxy;
        private std::chrono::seconds _timeout;
        private shared_ptr<http_client> httpClient;
        private Action _sessionHook;

        //private Cache cache = new Cache();

        private const map<string, string> _routes = 
        {
        ...
        Kite(string APIKey, string AccessToken = null, string Root = null, bool Debug = false, int Timeout = 7, WebProxy Proxy = null, int Pool = 2)
        {
...
private:
        ...
        /// <param name="Params">Additional paramerters</param>
        /// <returns>Varies according to API endpoint</returns>
        task<http_response> Post(string Route, Dictionary<string, dynamic> Params = null)
        {
